...
def _mobilenet_v3_conf(arch: str, params: Dict[str, Any]):
    ...
    if arch == "mobilenet_v3_large":
        # input_channels, kernel, expanded_channels, out_channesl, use_se, activation, stride, dilation
        inverted_residual_setting = [
            bneck_conf(16, 3, 16, 16, False, "RE", 1, 1),
            bneck_conf(16, 3, 64, 24, False, "RE", 2, 1),  # C1
            bneck_conf(24, 3, 72, 24, False, "RE", 1, 1),
            bneck_conf(24, 5, 72, 40, True, "RE", 1, 1),  # C2
            bneck_conf(40, 5, 120, 40, True, "RE", 1, 1),
            bneck_conf(40, 5, 120, 40, True, "RE", 1, 1),
            bneck_conf(40, 3, 240, 80, False, "HS", 1, 1),  # C3
            bneck_conf(80, 3, 200, 80, False, "HS", 2, 1),
    ...
    # intput_channels, kernel, expanded_channels, out_channels, use_se, activation, stride, dilation,           # width_mult
...
summary(model, (1,3,48,48), device="cpu")
exit()
# dummy_data = torch.empty(1, 3, 48, 48, dtype = torch.float32)
